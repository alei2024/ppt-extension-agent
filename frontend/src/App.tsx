    ...
    try {
      ...
      const searchStages = hasReferenceFiles
        ...
        : [
            ...
            { status: '正在提取关键词...', progress: 10 },
            { status: '正在检索 Arxiv、Semantic Scholar、Crossref、OpenAlex...', progress: 30 },
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={pptData.slides[currentSlide].text_boxes.length === 0}
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      title={selectedTextBoxes.length === 0 ? "请先选择要扩展的内容" : ""}
                    >
                    ...
                    <button
                      ...
                      disabled={isExpanding || (pptData.slides[currentSlide].text_boxes.length === 0)}
                      className="px-4 py-2 text-sm bg-primary-600 text-white rounded-md hover:bg-primary-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                      title={pptData.slides[currentSlide].text_boxes.length === 0 ? "本页没有可扩展的内容" : ""}
                    >
